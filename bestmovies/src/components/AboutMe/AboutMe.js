                    ...
                    <div className="aboutme__links">
                        <ul className="aboutme__links-list">
                            <li className="aboutme__item">
                                <a target="_blank"  rel="noreferrer" href="https://vk.com/ero2k" className="aboutme__link">VK</a>
                            </li>
                            <li className="aboutme__item">
                                <a target="_blank" rel="noreferrer" href="https://github.com/ero2k" className="aboutme__link">Github</a>
                            </li>
            ...
            <div className="aboutme__portfolio">
                ...
                <ul className="aboutme__portfolio-list">
                    <li className="aboutme__portfolio-item">
                        <a target="_blank" rel="noreferrer" href="https://ero2k.github.io/how-to-learn/"
                           className="aboutme__portfolio-link">Статичный сайт</a>
                    </li>
                    <li className="aboutme__portfolio-item">
                        <a target="_blank" rel="noreferrer" href="https://ero2k.github.io/russian-travel/"
                           className="aboutme__portfolio-link">Адаптивный сайт</a>
                    </li>
                    <li className="aboutme__portfolio-item">
                        <a target="_blank" rel="noreferrer" href="https://ero2k.github.io/mesto/" className="aboutme__portfolio-link">Одностраничное
                            приложение</a>
                    </li>
                </ul>
            </div>
