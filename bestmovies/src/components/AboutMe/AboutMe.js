    ...
    return (
        <section className="aboutme max-width">
            ...
            <div className="aboutme__student">
                ...
                <p className="font-size_paragraph  aboutme__description">Я родился и живу в Саратове, закончил факультет экономики СГУ. У
                    меня есть жена
            ...
            <div className="aboutme__portfolio">
                ...
                <ul className="aboutme__portfolio-list">
                    <li className="aboutme__portfolio-link">Статичный сайт</li>
                    <li className="aboutme__portfolio-link">Адаптивный сайт</li>
                    <li className="aboutme__portfolio-link">Одностраничное приложение</li>
                </ul>
            </div>
        </section>
    )
